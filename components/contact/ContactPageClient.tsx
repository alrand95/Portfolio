...
import {
    ...
    Sparkles, Send, Rocket, Heart, Moon, User
} from 'lucide-react';
...
function NeonMagicBackground() {
    ...
    const getIcon = (type: number, className: string) => {
        switch (type) {
            ...
            case 2: return <Sparkles className={className} />;
...
export function ContactPageClient({ profile, socials, dbContent }: ContactPageClientProps) {
    ...
    return (
        <main className="min-h-screen pt-32 pb-12 px-4 md:px-8 relative bg-black overflow-hidden selection:bg-neon-pink selection:text-white">
            <NeonMagicBackground />
