...
import { X, Zap, Star, Heart, Sparkles, Cake } from "lucide-react";
import confetti from "canvas-confetti";
import { useLanguage } from "@/lib/i18n/context";
import Image from "next/image";

export function AdminBirthdayCelebration() {
    ...
    const content = {
        en: {
            ...
            message: "May Allah bless you with happiness and health always. I love your laugh, your voice, and every moment with you. Soon, we’ll have a lovely family together. My heart is yours, forever.",
            blow: "Blow the Candle!",
            wish: "Make a Wish!"
        },
        ar: {
            title: "عيد ميلاد سعيد،",
            subtitle: "يا زوجتي الجميلة.",
            message: "أسأل الله أن يرزقك السعادة والصحة دائماً. أحب ضحكتك وصوتك وكل لحظة معك. قريباً، سنكون عائلة جميلة معاً. قلبي لك، إلى الأبد.",
            blow: "اطفئ الشمعة!",
            wish: "تمنى أمنية!"
        }
    };
    ...
    useEffect(() => {
        const checkDate = () => {
            ...
            if (isBirthday) {
                ...
                const storageKey = `birthday_admin_shown_${year}`;
            ...
            {isVisible && (
                ...
                >
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-gradient-to-br from-pink-900/40 via-purple-900/30 to-black/50 backdrop-blur-xl border border-pink-400/20 rounded-[3rem] p-8 shadow-[0_8px_32px_0_rgba(236,72,153,0.4)] overflow-visible"
                    >
                            ...
                            <div className="relative w-64 h-64 flex justify-center items-center">
                                ...
                                >
                                    ...
                                    <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-xl">
                                        ...
                                        {/* Gradient Pink Cake */}
                                        <path d="M40,140 L160,140 L160,170 C160,180 140,190 100,190 C60,190 40,180 40,170 Z" fill="url(#cakeGradient)" />
                                        ...
                                        <path d="M55,100 L145,100 L145,130 C145,140 125,145 100,145 C75,145 55,140 55,130 Z" fill="url(#cakeGradient)" />
                        ...
                        <div className="flex flex-col items-center text-center relative z-10 mt-4">
                            ...
                            <motion.button
                                ...
                                className="px-8 py-3 bg-gradient-to-r from-pink-500/30 to-purple-500/30 hover:from-pink-500/40 hover:to-purple-500/40 border border-pink-300/40 rounded-full text-white font-bold shadow-lg transition-all flex items-center justify-center gap-2 backdrop-blur-md"
